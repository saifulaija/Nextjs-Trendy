...
import ProductSizes from "@/components/shared/productCard/ProductSizes";
import QuickViewProduct from "@/components/shared/quickViewProduct/QuickViewProduct";

const SearchProductCard = ({ product }: { product: TProduct }) => {
