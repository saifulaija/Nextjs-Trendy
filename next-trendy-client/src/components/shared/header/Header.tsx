      ...
      <div className="container mx-auto px-4">
        <header className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <motion.div
              className="hidden md:flex items-center space-x-3 px-4 py-2 hover:bg-gray-100 rounded-lg transition-colors duration-300"
              animate={{ x: xOffset }}
            ...
            >
              <Link href="/">
                <Image
                  src={assets.images.logo}
                  alt="Trendy Logo"
                  width={70} // Adjusted for a refined look
                  height={70}
